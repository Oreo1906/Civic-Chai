...
export function SignUp({ onBackClick, onLoginClick }: { onBackClick?: () => void; onLoginClick?: () => void }) {
    ...
    <div className="h-screen w-full flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12 h-screen sticky top-0">
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            Join thousands of citizens raising their voices, sparking
            discussions, and driving real change in communities
            across India.
          </p>
      ...
      <div className="w-full lg:w-1/2 bg-[#FAF8F5] flex flex-col items-center justify-center px-6 py-12 relative overflow-y-auto h-screen">
        ...
        >
          ...
          <div className="mb-8">
            ...
            >
              Join Civic Chai and start making a difference today.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-3">
              <button
                ...
                className={`w-5 h-5 mt-0.5 rounded-md border-2 flex items-center justify-center flex-shrink-0 transition-all duration-200 ${
                  agreed
              ...
              <span
                className="text-gray-500 leading-relaxed cursor-pointer select-none"
                onClick={() => setAgreed(!agreed)}
                style={{
                  fontFamily: "'Poppins', sans-serif",
                  fontSize: '0.82rem',
              ...
              >
                I agree to the{' '}
                <a href="#" className="text-gray-900 font-semibold hover:text-orange-500 transition-colors duration-200 underline underline-offset-2">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="text-gray-900 font-semibold hover:text-orange-500 transition-colors duration-200 underline underline-offset-2">
